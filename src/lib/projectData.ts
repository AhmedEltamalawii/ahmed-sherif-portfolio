...
export const projects: ProjectDetail[] = [
  ...
  {
    slug: "legumes-factory",
    title: "Legumes Factory Platform",
    desc: "A full-featured web application built for a legumes factory using HTML, CSS, and JavaScript — designed to streamline operations with a modern, user-friendly interface for both administrators and customers. The platform features a powerful Admin Dashboard providing complete control over products, including managing different crop types (staple and strategic crops), updating inventory, and organizing product categories. It includes a smart system for tracking required quantities and managing supply needs to improve planning and decision-making. A robust user management system lets admins monitor and control all user access. The site integrates WhatsApp communication for instant messaging between users and the business — enhancing customer engagement, support, and satisfaction. Built with focus on performance, usability, and scalability.",
    overview: "A full-featured legumes factory web app with admin dashboard, crop & inventory management, user control, and WhatsApp integration for instant customer support.",
    features: [
      { icon: "Layout", label: "Powerful Admin Dashboard for Full Control" },
      { icon: "Database", label: "Crop Management (Staple & Strategic Categories)" },
      { icon: "Workflow", label: "Inventory Tracking & Supply Needs Planning" },
      { icon: "Shield", label: "Complete User Management & Access Control" },
      { icon: "Mail", label: "WhatsApp Integration for Instant Communication" },
      { icon: "Code2", label: "Responsive, Performant & Scalable Front-End" },
    ],
    techStack: [
      { label: "HTML", color: "orange" },
      { label: "CSS", color: "blue" },
      { label: "JavaScript", color: "green" },
      { label: "Responsive Design", color: "purple" },
      { label: "WhatsApp API", color: "red" },
    ],
    ...
    images: [
      ...
      { src: "/placeholder.svg", title: "Inventory & Supply", description: "Track quantities and supply needs", category: "screenshot" },
      { src: "/placeholder.svg", title: "WhatsApp Integration", description: "Instant messaging with customers", category: "screenshot" },
    ],
  },
];
