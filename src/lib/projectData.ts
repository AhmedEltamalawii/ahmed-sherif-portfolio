...
export const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    desc: "A comprehensive hotel management platform built with ASP.NET Core, designed to streamline hospitality operations from booking to checkout. The system integrates secure Stripe payment processing for instant booking confirmations, eliminating no-show risks and stabilizing cash flow. Features automated guest communications with digital receipts, real-time room inventory management to prevent double-bookings, and a professional guest journey from first click to confirmation email. The platform demonstrates expertise in payment integration, real-time inventory systems, and building trust-driven user experiences for the hospitality industry.",
    overview: "A comprehensive hotel management platform with secure payments, real-time inventory, and automated guest communications for modern hospitality.",
    features: [
    ...
    tech: ["ASP.NET Core", "SQL Server", "Stripe", "Entity Framework", "Bootstrap 5"],
    github: "",
    demo: "",
    images: [
      { src: "/placeholder.svg", title: "Dashboard", description: "Hotel management dashboard overview", category: "screenshot" },
      { src: "/placeholder.svg", title: "Booking System", description: "Room booking and availability", category: "screenshot" },
      { src: "/placeholder.svg", title: "Payment Flow", description: "Secure Stripe checkout process", category: "screenshot" },
    ],
  },
  {
