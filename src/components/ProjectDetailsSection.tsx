...
const projectDetails: ProjectDetail[] = [
  ...
  },
  {
    ...
    overview:
      "A full-featured legumes factory web app with admin dashboard, crop & inventory management, user control, and WhatsApp integration for instant customer support.",
    features: [
      { icon: <Layout size={18} />, label: "Powerful Admin Dashboard for Full Control" },
      { icon: <Database size={18} />, label: "Crop Management (Staple & Strategic Categories)" },
      { icon: <Workflow size={18} />, label: "Inventory Tracking & Supply Needs Planning" },
      { icon: <Shield size={18} />, label: "Complete User Management & Access Control" },
      { icon: <Code2 size={18} />, label: "WhatsApp Integration for Instant Communication" },
    ],
    techStack: [
    ...
    images: [
      { src: "/placeholder.svg", title: "Admin Dashboard", description: "Full control panel", category: "screenshot" },
      { src: "/placeholder.svg", title: "Crop Management", description: "Staple & strategic crops", category: "screenshot" },
      { src: "/placeholder.svg", title: "Inventory Tracking", description: "Supply needs planning", category: "screenshot" },
      { src: "/placeholder.svg", title: "WhatsApp Integration", description: "Instant customer support", category: "mockup" },
    ],
  },
];
